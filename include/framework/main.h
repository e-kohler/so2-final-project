...
#define BIND(X) typedef _SYS::IF<(_SYS::Traits<_SYS::X>::ASPECTS::Length || (_SYS::Traits<_SYS::Build>::MODE == _SYS::Traits<_SYS::Build>::KERNEL || _SYS::Traits<_SYS::Build>::MODE == _SYS::Traits<_SYS::Build>::BUILTIN)), _SYS::Handle<_SYS::X>, _SYS::X>::Result X;

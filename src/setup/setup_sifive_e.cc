...
Setup::Setup()
{
    ...
    if(Traits<System>::multitask) {
        ...
        db<Setup>(TRC) << sizeof(EPOS::System_Info) << endl;
...
void Setup::load_parts()
{
    ...
    db<Setup>(TRC) << "Setup::phy " << si << " log " << reinterpret_cast<void *>(SYS_INFO) << "si_pmm " << reinterpret_cast<void *>(si->pmm.sys_info) << endl;

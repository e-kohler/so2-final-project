...
public:
    Init_System() {
        ...
        if(Traits<System>::multiheap) {
            ...
            System::_heap_segment = new (tmp) Segment(HEAP_SIZE, Segment::Flags::SYS);
            System::_heap = new (&System::_preheap[sizeof(Segment)]) Heap(System::_heap_segment->phy_address(), System::_heap_segment->size());
        } else
